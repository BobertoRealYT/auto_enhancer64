...
export default function N64EmulatorFrontend() {
  ...
  useEffect(() => {
    ...
    ctx.fillText(
      `Controls: ${keybinds.dpadUp}/${keybinds.dpadDown}/${keybinds.dpadLeft}/${keybinds.dpadRight} • A:${keybinds.a} • B:${keybinds.b}`,
      40,
      270
    )
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button
              onClick={async () => {
                ...
                setMessage("Install the app using your browser's Install App option or Add to Home Screen.")
              }}
